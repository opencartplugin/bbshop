...
<?= $this->element('Form/nav-top', [
        'title' => 'Role',
        'links' => [['class'=>'fa fa-list', 'title'=>'Daftar Role', 'action'=>'index','method'=>'link'], ['class'=>'fa fa-remove', 'title'=>'Delete', 'action'=>'delete', 'method'=>'postlink','confirm'=>__('Are you sure you want to delete # {0}?', $role->id), 'id'=>$role->id],
        ]]);?>
